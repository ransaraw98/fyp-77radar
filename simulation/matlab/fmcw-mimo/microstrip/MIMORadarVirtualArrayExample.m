...
car_dist = [40 50 100 20];              % Distance between sensor and cars (meters)
car_speed = [-80 96 50 25]*1000/3600;  % km/h -> m/s
car_az = [-10 10 30 -30];
car_rcs = [20 40 10 10];
car_pos = [car_dist.*cosd(car_az);car_dist.*sind(car_az);0.5 0.5 0.5 0.5];
