...
#
# project.tcl: Tcl script for re-creating project 'buffer_test'
#
# Generated by Vivado on Mon May 08 21:50:19 +0530 2023
...
#
#    "/home/ransara/Documents/FYP/fyp-77radar/impl/proj_zuplus/buffer_test/buffer_test.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "/home/ransara/Documents/FYP/fyp-77radar/impl/proj_zuplus/buffer_test/buffer_test.srcs/sim_1/new/sample_gen_tb.v"
#    "/home/ransara/Documents/FYP/fyp-77radar/impl/proj_zuplus/buffer_test/sample_gen_tb_behav.wcfg"
#
...
set _xil_proj_name_ "buffer_test"
...
set files [list \
 [file normalize "${origin_dir}/buffer_test.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/buffer_test.srcs/sim_1/new/sample_gen_tb.v" ]\
 [file normalize "${origin_dir}/sample_gen_tb_behav.wcfg" ]\
]
...
set file "buffer_test/sample_gen_tb_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set_property -name "top" -value "sample_gen_tb" -objects $obj
...
#  -string -flagsOSRD
preplace port M_AXIS -pg 1 -lvl 2 -x 340 -y 70 -defaultsOSRD
preplace port m_axis_aclk -pg 1 -lvl 0 -x -80 -y 140 -defaultsOSRD
preplace port m_axis_aresetn -pg 1 -lvl 0 -x -80 -y 170 -defaultsOSRD
preplace portBus PACKET_SIZE -pg 1 -lvl 0 -x -80 -y 90 -defaultsOSRD
preplace inst buffer1_0 -pg 1 -lvl 1 -x 140 -y 120 -defaultsOSRD
preplace netloc m_axis_aclk_1 1 0 1 -60 120n
preplace netloc m_axis_aresetn_1 1 0 1 -50 140n
preplace netloc PACKET_SIZE_1 1 0 1 -60 90n
preplace netloc buffer1_0_M_AXIS 1 1 1 N 70
levelinfo -pg 1 -80 140 340
pagesize -pg 1 -db -bbox -sgen -270 -10 450 230
"
}
