...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:ping_pong_buf:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins ping_pong_buf_0/S_AXIS]
  ...
  connect_bd_net -net s_axis_aresetn_1 [get_bd_ports s_axis_aresetn] [get_bd_pins ping_pong_buf_0/s_axis_aresetn]
