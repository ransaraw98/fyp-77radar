...
proc update_PARAM_VALUE.ADDRW { PARAM_VALUE.ADDRW } {
	# Procedure called to update ADDRW when any of the dependent parameters in the arguments change
}
...
proc update_MODELPARAM_VALUE.ADDRW { MODELPARAM_VALUE.ADDRW PARAM_VALUE.ADDRW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADDRW}] ${MODELPARAM_VALUE.ADDRW}
}
