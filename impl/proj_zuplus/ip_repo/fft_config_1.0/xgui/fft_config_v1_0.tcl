...
proc init_gui { IPINST } {
  ...
  set CONFIG_DATA [ipgui::add_param $IPINST -name "CONFIG_DATA"]
  set_property tooltip {Will be zero padded to 8 bit boundaries.} ${CONFIG_DATA}

}

proc update_PARAM_VALUE.CONFIG_DATA { PARAM_VALUE.CONFIG_DATA } {
	# Procedure called to update CONFIG_DATA when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CONFIG_DATA { PARAM_VALUE.CONFIG_DATA } {
	# Procedure called to validate CONFIG_DATA
	return true
}
...
proc update_MODELPARAM_VALUE.CONFIG_DATA { MODELPARAM_VALUE.CONFIG_DATA PARAM_VALUE.CONFIG_DATA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CONFIG_DATA}] ${MODELPARAM_VALUE.CONFIG_DATA}
}
