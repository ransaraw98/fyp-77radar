...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net radarIMG_rom_0_M_AXIS [get_bd_intf_ports M_AXIS] [get_bd_intf_pins radarIMG_rom_0/M_AXIS]

  # Create port connections
  connect_bd_net -net m_axis_aclk_1 [get_bd_ports m_axis_aclk] [get_bd_pins radarIMG_rom_0/m_axis_aclk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_ports m_axis_aresetn] [get_bd_pins radarIMG_rom_0/m_axis_aresetn]
