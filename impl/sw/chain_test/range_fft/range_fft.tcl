...
################################################################
# This is a generated script based on design: range_fft
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rom_out, and set properties
  set rom_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 rom_out ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net radarIMG_rom_0_M_AXIS [get_bd_intf_pins radarIMG_rom_0/M_AXIS] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
connect_bd_intf_net -intf_net [get_bd_intf_nets radarIMG_rom_0_M_AXIS] [get_bd_intf_pins radarIMG_rom_0/M_AXIS] [get_bd_intf_pins rom_out/SLOT_0_AXIS]
  ...
  connect_bd_net -net rst_ps8_0_249M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins radarIMG_rom_0/m_axis_aresetn] [get_bd_pins rst_ps8_0_249M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
  connect_bd_net -net xfft_0_event_data_in_channel_halt [get_bd_pins ila_0/probe4] [get_bd_pins xfft_0/event_data_in_channel_halt]
  connect_bd_net -net xfft_0_event_data_out_channel_halt [get_bd_pins ila_0/probe5] [get_bd_pins xfft_0/event_data_out_channel_halt]
  connect_bd_net -net xfft_0_event_frame_started [get_bd_pins ila_0/probe0] [get_bd_pins xfft_0/event_frame_started]
  connect_bd_net -net xfft_0_event_status_channel_halt [get_bd_pins ila_0/probe3] [get_bd_pins xfft_0/event_status_channel_halt]
  connect_bd_net -net xfft_0_event_tlast_missing [get_bd_pins ila_0/probe2] [get_bd_pins xfft_0/event_tlast_missing]
  connect_bd_net -net xfft_0_event_tlast_unexpected [get_bd_pins ila_0/probe1] [get_bd_pins xfft_0/event_tlast_unexpected]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ila_0/clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins radarIMG_rom_0/m_axis_aclk] [get_bd_pins rom_out/clk] [get_bd_pins rst_ps8_0_249M/slowest_sync_clk] [get_bd_pins xfft_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
