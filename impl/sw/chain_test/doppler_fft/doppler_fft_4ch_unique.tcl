...
################################################################
# This is a generated script based on design: doppler_fft
#
...
xilinx.com:user:radarIMG_rom2:1.0\
xilinx.com:user:radarIMG_rom3:1.0\
xilinx.com:user:radarIMG_rom4:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: comb_out, and set properties
  set comb_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 comb_out ]
  set_property -dict [ list \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
 ] $comb_out

  # Create instance: dopp_config, and set properties
  set dopp_config [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 dopp_config ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {15} \
   CONFIG.CONST_WIDTH {48} \
 ] $dopp_config

  # Create instance: dopp_config_tvalid, and set properties
  set dopp_config_tvalid [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 dopp_config_tvalid ]

  # Create instance: doppler_fft, and set properties
  set doppler_fft [ create_bd_cell -type ip -vlnv xilinx.com:ip:xfft:9.1 doppler_fft ]
  set_property -dict [ list \
   CONFIG.aresetn {true} \
   CONFIG.channels {4} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S_AXIS_TDATA_WIDTH {128} \
   CONFIG.RAM_ADDRW {7} \
  ...
  # Create instance: radarIMG_rom2_0, and set properties
  set radarIMG_rom2_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom2:1.0 radarIMG_rom2_0 ]

  # Create instance: radarIMG_rom3_0, and set properties
  set radarIMG_rom3_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom3:1.0 radarIMG_rom3_0 ]

  # Create instance: radarIMG_rom4_0, and set properties
  set radarIMG_rom4_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom4:1.0 radarIMG_rom4_0 ]
  ...
  # Create instance: range_config, and set properties
  set range_config [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 range_config ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {183217855} \
  ...
  # Create instance: range_tvalid, and set properties
  set range_tvalid [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 range_tvalid ]
  ...
  # Create instance: rom1_out, and set properties
  set rom1_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 rom1_out ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART 1#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins axis_combiner_0/M_AXIS] [get_bd_intf_pins range_fft/S_AXIS_DATA]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_combiner_0_M_AXIS] [get_bd_intf_pins axis_combiner_0/M_AXIS] [get_bd_intf_pins comb_out/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net doppler_fft_M_AXIS_DATA [get_bd_intf_pins doppler_fft/M_AXIS_DATA] [get_bd_intf_pins ping_pong_buf_0/S_AXIS]
  connect_bd_intf_net -intf_net ping_pong_buf_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins ping_pong_buf_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_perf_mon_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net radarIMG_rom2_0_M_AXIS [get_bd_intf_pins axis_combiner_0/S01_AXIS] [get_bd_intf_pins radarIMG_rom2_0/M_AXIS]
  connect_bd_intf_net -intf_net radarIMG_rom3_0_M_AXIS [get_bd_intf_pins axis_combiner_0/S02_AXIS] [get_bd_intf_pins radarIMG_rom3_0/M_AXIS]
  connect_bd_intf_net -intf_net radarIMG_rom4_0_M_AXIS [get_bd_intf_pins axis_combiner_0/S03_AXIS] [get_bd_intf_pins radarIMG_rom4_0/M_AXIS]
  connect_bd_intf_net -intf_net radarIMG_rom_0_M_AXIS [get_bd_intf_pins axis_combiner_0/S00_AXIS] [get_bd_intf_pins radarIMG_rom_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets radarIMG_rom_0_M_AXIS] [get_bd_intf_pins radarIMG_rom_0/M_AXIS] [get_bd_intf_pins rom1_out/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net rearrng_ppong_buf_0_M_AXIS1 [get_bd_intf_pins doppler_fft/S_AXIS_DATA] [get_bd_intf_pins rearrng_ppong_buf_0/M_AXIS]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins range_fft/M_AXIS_DATA] [get_bd_intf_pins rearrng_ppong_buf_0/S_AXIS]
  ...
  connect_bd_net -net axi_perf_mon_0_interrupt [get_bd_pins axi_perf_mon_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net doppler_fft_event_data_in_channel_halt [get_bd_pins doppler_fft/event_data_in_channel_halt] [get_bd_pins ila_1/probe4]
  connect_bd_net -net doppler_fft_event_data_out_channel_halt [get_bd_pins doppler_fft/event_data_out_channel_halt] [get_bd_pins ila_1/probe5]
  connect_bd_net -net doppler_fft_event_frame_started [get_bd_pins doppler_fft/event_frame_started] [get_bd_pins ila_1/probe0]
  connect_bd_net -net doppler_fft_event_status_channel_halt [get_bd_pins doppler_fft/event_status_channel_halt] [get_bd_pins ila_1/probe3]
  connect_bd_net -net doppler_fft_event_tlast_missing [get_bd_pins doppler_fft/event_tlast_missing] [get_bd_pins ila_1/probe2]
  connect_bd_net -net doppler_fft_event_tlast_unexpected [get_bd_pins doppler_fft/event_tlast_unexpected] [get_bd_pins ila_1/probe1]
  connect_bd_net -net rearrng_ppong_buf_0_rx_done_out [get_bd_pins ila_1/probe7] [get_bd_pins rearrng_ppong_buf_0/rx_done_out]
  connect_bd_net -net rearrng_ppong_buf_0_tx_done_out [get_bd_pins ila_1/probe6] [get_bd_pins rearrng_ppong_buf_0/tx_done_out]
  connect_bd_net -net rst_ps8_0_249M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins doppler_fft/aresetn] [get_bd_pins ping_pong_buf_0/m_axis_aresetn] [get_bd_pins ping_pong_buf_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins radarIMG_rom2_0/m_axis_aresetn] [get_bd_pins radarIMG_rom3_0/m_axis_aresetn] [get_bd_pins radarIMG_rom4_0/m_axis_aresetn] [get_bd_pins radarIMG_rom_0/m_axis_aresetn] [get_bd_pins range_fft/aresetn] [get_bd_pins rearrng_ppong_buf_0/m_axis_aresetn] [get_bd_pins rearrng_ppong_buf_0/s_axis_aresetn] [get_bd_pins rst_ps8_0_249M/peripheral_aresetn]
  connect_bd_net -net xfft_0_event_data_in_channel_halt [get_bd_pins ila_0/probe4] [get_bd_pins range_fft/event_data_in_channel_halt]
  connect_bd_net -net xfft_0_event_data_out_channel_halt [get_bd_pins ila_0/probe5] [get_bd_pins range_fft/event_data_out_channel_halt]
  connect_bd_net -net xfft_0_event_frame_started [get_bd_pins ila_0/probe0] [get_bd_pins range_fft/event_frame_started]
  connect_bd_net -net xfft_0_event_status_channel_halt [get_bd_pins ila_0/probe3] [get_bd_pins range_fft/event_status_channel_halt]
  connect_bd_net -net xfft_0_event_tlast_missing [get_bd_pins ila_0/probe2] [get_bd_pins range_fft/event_tlast_missing]
  connect_bd_net -net xfft_0_event_tlast_unexpected [get_bd_pins ila_0/probe1] [get_bd_pins range_fft/event_tlast_unexpected]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins range_fft/s_axis_config_tvalid] [get_bd_pins range_tvalid/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins range_config/dout] [get_bd_pins range_fft/s_axis_config_tdata]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins dopp_config_tvalid/dout] [get_bd_pins doppler_fft/s_axis_config_tvalid]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins dopp_config/dout] [get_bd_pins doppler_fft/s_axis_config_tdata]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins comb_out/clk] [get_bd_pins doppler_fft/aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ping_pong_buf_0/m_axis_aclk] [get_bd_pins ping_pong_buf_0/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins radarIMG_rom2_0/m_axis_aclk] [get_bd_pins radarIMG_rom3_0/m_axis_aclk] [get_bd_pins radarIMG_rom4_0/m_axis_aclk] [get_bd_pins radarIMG_rom_0/m_axis_aclk] [get_bd_pins range_fft/aclk] [get_bd_pins rearrng_ppong_buf_0/m_axis_aclk] [get_bd_pins rearrng_ppong_buf_0/s_axis_aclk] [get_bd_pins rom1_out/clk] [get_bd_pins rst_ps8_0_249M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_perf_mon_0/S_AXI/Reg] SEG_axi_perf_mon_0_Reg
