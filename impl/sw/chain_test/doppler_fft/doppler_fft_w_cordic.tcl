...
proc create_root_design { parentCell } {
  ...
  # Create instance: dop_in, and set properties
  set dop_in [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 dop_in ]
  set_property -dict [ list \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
 ] $dop_in

  # Create instance: dop_out, and set properties
  set dop_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 dop_out ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net doppler_fft_M_AXIS_DATA [get_bd_intf_pins cordic_0/S_AXIS_CARTESIAN] [get_bd_intf_pins doppler_fft/M_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net radarIMG_rom_0_M_AXIS [get_bd_intf_pins radarIMG_rom_0/M_AXIS] [get_bd_intf_pins range_fft/S_AXIS_DATA]
  connect_bd_intf_net -intf_net rearrng_ppong_buf_0_M_AXIS [get_bd_intf_pins cordic_0/M_AXIS_DOUT] [get_bd_intf_pins ping_pong_buf_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets rearrng_ppong_buf_0_M_AXIS] [get_bd_intf_pins cordic_0/M_AXIS_DOUT] [get_bd_intf_pins dop_out/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rearrng_ppong_buf_0_M_AXIS1] [get_bd_intf_pins dop_in/SLOT_0_AXIS] [get_bd_intf_pins rearrng_ppong_buf_0/M_AXIS]
