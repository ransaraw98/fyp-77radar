...
proc create_root_design { parentCell } {
  ...
  # Create instance: radarIMG_rom_1, and set properties
  set radarIMG_rom_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom:1.0 radarIMG_rom_1 ]

  # Create instance: radarIMG_rom_2, and set properties
  set radarIMG_rom_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom:1.0 radarIMG_rom_2 ]

  # Create instance: radarIMG_rom_3, and set properties
  set radarIMG_rom_3 [ create_bd_cell -type ip -vlnv xilinx.com:user:radarIMG_rom:1.0 radarIMG_rom_3 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_combiner_0_M_AXIS] [get_bd_intf_pins axis_combiner_0/M_AXIS] [get_bd_intf_pins comb_out/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net radarIMG_rom_1_M_AXIS [get_bd_intf_pins axis_combiner_0/S01_AXIS] [get_bd_intf_pins radarIMG_rom_1/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets radarIMG_rom_1_M_AXIS] [get_bd_intf_pins radarIMG_rom_1/M_AXIS] [get_bd_intf_pins rom1_out/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net radarIMG_rom_2_M_AXIS [get_bd_intf_pins axis_combiner_0/S02_AXIS] [get_bd_intf_pins radarIMG_rom_2/M_AXIS]
  connect_bd_intf_net -intf_net radarIMG_rom_3_M_AXIS [get_bd_intf_pins axis_combiner_0/S03_AXIS] [get_bd_intf_pins radarIMG_rom_3/M_AXIS]
  ...
  connect_bd_net -net rst_ps8_0_249M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins doppler_fft/aresetn] [get_bd_pins ping_pong_buf_0/m_axis_aresetn] [get_bd_pins ping_pong_buf_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins radarIMG_rom_0/m_axis_aresetn] [get_bd_pins radarIMG_rom_1/m_axis_aresetn] [get_bd_pins radarIMG_rom_2/m_axis_aresetn] [get_bd_pins radarIMG_rom_3/m_axis_aresetn] [get_bd_pins range_fft/aresetn] [get_bd_pins rearrng_ppong_buf_0/m_axis_aresetn] [get_bd_pins rearrng_ppong_buf_0/s_axis_aresetn] [get_bd_pins rst_ps8_0_249M/peripheral_aresetn]
