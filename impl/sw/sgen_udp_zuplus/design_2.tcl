...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_sgen_0, and set properties
  set axis_sgen_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_sgen:1.0 axis_sgen_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axis_sgen_0_M_AXIS [get_bd_intf_pins axis_sgen_0/M_AXIS] [get_bd_intf_pins ping_pong_buf_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_sgen_0_M_AXIS] [get_bd_intf_pins axis_sgen_0/M_AXIS] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ping_pong_buf_0_M_AXIS] [get_bd_intf_pins ila_1/SLOT_0_AXIS] [get_bd_intf_pins ping_pong_buf_0/M_AXIS]
  ...
  connect_bd_net -net rst_ps8_0_249M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_sgen_0/m_axis_aresetn] [get_bd_pins ping_pong_buf_0/m_axis_aresetn] [get_bd_pins ping_pong_buf_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_249M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_sgen_0/PACKET_SIZE] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_sgen_0/m_axis_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins ping_pong_buf_0/m_axis_aclk] [get_bd_pins ping_pong_buf_0/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_249M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
