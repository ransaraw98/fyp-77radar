...
proc create_root_design { parentCell } {
  ...
  # Create instance: config_data, and set properties
  set config_data [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 config_data ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {215} \
   CONFIG.CONST_WIDTH {16} \
 ] $config_data

  # Create instance: fft_valid, and set properties
  set fft_valid [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 fft_valid ]
  ...
  # Create instance: smart_connect, and set properties
  set smart_connect [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 smart_connect ]
  set_property -dict [ list \
   CONFIG.NUM_SI {2} \
 ] $smart_connect
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART 1#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins smart_connect/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins smart_connect/S01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins smart_connect/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins smart_connect/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins range_fft/S_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins range_fft/M_AXIS_DATA]
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins ila_0/SLOT_0_AXIS] [get_bd_intf_pins range_fft/M_AXIS_DATA]
  ...
  connect_bd_net -net config_data_dout [get_bd_pins config_data/dout] [get_bd_pins range_fft/s_axis_config_tdata] [get_bd_pins vio_0/probe_in6]
  connect_bd_net -net fft_valid_dout [get_bd_pins fft_valid/dout] [get_bd_pins range_fft/s_axis_config_tvalid] [get_bd_pins vio_0/probe_in8]
  connect_bd_net -net range_fft_event_data_in_channel_halt [get_bd_pins range_fft/event_data_in_channel_halt] [get_bd_pins vio_0/probe_in4]
  connect_bd_net -net range_fft_event_data_out_channel_halt [get_bd_pins range_fft/event_data_out_channel_halt] [get_bd_pins vio_0/probe_in5]
  connect_bd_net -net range_fft_event_frame_started [get_bd_pins range_fft/event_frame_started] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net range_fft_event_status_channel_halt [get_bd_pins range_fft/event_status_channel_halt] [get_bd_pins vio_0/probe_in3]
  connect_bd_net -net range_fft_event_tlast_missing [get_bd_pins range_fft/event_tlast_missing] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net range_fft_event_tlast_unexpected [get_bd_pins range_fft/event_tlast_unexpected] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net range_fft_s_axis_config_tready [get_bd_pins range_fft/s_axis_config_tready] [get_bd_pins vio_0/probe_in7]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins smart_connect/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins range_fft/aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smart_connect/aclk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
