...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:SGEN_cyclic:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: SGEN_cyclic_0, and set properties
  set SGEN_cyclic_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:SGEN_cyclic:1.0 SGEN_cyclic_0 ]
  ...
  # Create instance: buf_out, and set properties
  set buf_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 buf_out ]
  set_property -dict [ list \
  ...
  # Create instance: cordic_out, and set properties
  set cordic_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 cordic_out ]
  set_property -dict [ list \
   CONFIG.C_DATA_DEPTH {2048} \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
  ...
  # Create instance: fft_config_data, and set properties
  set fft_config_data [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 fft_config_data ]
  set_property -dict [ list \
  ...
  # Create instance: fft_to_cordic, and set properties
  set fft_to_cordic [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 fft_to_cordic ]
  set_property -dict [ list \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
 ] $fft_to_cordic
  ...
  # Create instance: rst_ps8_0_249M_1, and set properties
  set rst_ps8_0_249M_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_249M_1 ]

  # Create instance: sgen_out, and set properties
  set sgen_out [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 sgen_out ]
  set_property -dict [ list \
   CONFIG.C_NUM_OF_PROBES {9} \
   CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S} \
 ] $sgen_out
  ...
  connect_bd_intf_net -intf_net SGEN_cyclic_0_M_AXIS [get_bd_intf_pins SGEN_cyclic_0/M_AXIS] [get_bd_intf_pins ping_pong_buf_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets SGEN_cyclic_0_M_AXIS] [get_bd_intf_pins SGEN_cyclic_0/M_AXIS] [get_bd_intf_pins sgen_out/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axis_sgen_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins cordic_0/M_AXIS_DOUT]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_sgen_0_M_AXIS] [get_bd_intf_pins cordic_0/M_AXIS_DOUT] [get_bd_intf_pins cordic_out/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net ping_pong_buf_0_M_AXIS1 [get_bd_intf_pins ping_pong_buf_0/M_AXIS] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
connect_bd_intf_net -intf_net [get_bd_intf_nets ping_pong_buf_0_M_AXIS1] [get_bd_intf_pins buf_out/SLOT_0_AXIS] [get_bd_intf_pins ping_pong_buf_0/M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins fft_to_cordic/SLOT_0_AXIS] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_net -net fft_config_valid_dout [get_bd_pins fft_config_valid/dout] [get_bd_pins xfft_0/s_axis_config_tvalid]
  connect_bd_net -net rst_ps8_0_249M_1_peripheral_aresetn [get_bd_pins SGEN_cyclic_0/m_axis_aresetn] [get_bd_pins ping_pong_buf_0/s_axis_aresetn] [get_bd_pins rst_ps8_0_249M_1/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_249M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ping_pong_buf_0/m_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_125M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins SGEN_cyclic_0/PACKET_SIZE] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins fft_config_data/dout] [get_bd_pins xfft_0/s_axis_config_tdata]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins buf_out/clk] [get_bd_pins cordic_0/aclk] [get_bd_pins cordic_out/clk] [get_bd_pins fft_to_cordic/clk] [get_bd_pins ping_pong_buf_0/m_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_125M/slowest_sync_clk] [get_bd_pins xfft_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins SGEN_cyclic_0/m_axis_aclk] [get_bd_pins ping_pong_buf_0/s_axis_aclk] [get_bd_pins rst_ps8_0_249M_1/slowest_sync_clk] [get_bd_pins sgen_out/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_125M/ext_reset_in] [get_bd_pins rst_ps8_0_249M_1/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
