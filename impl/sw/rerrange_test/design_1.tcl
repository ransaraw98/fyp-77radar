...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_0_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axis_sgen_0_M_AXIS [get_bd_intf_pins axis_sgen_0/M_AXIS] [get_bd_intf_pins rearrng_ppong_buf_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net rearrng_ppong_buf_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins rearrng_ppong_buf_0/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets rearrng_ppong_buf_0_M_AXIS]
